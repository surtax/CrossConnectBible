...
/**
 * THis class should always have a scrollview wwrapping around it
 * @author garylo
 *
 */
public class BibleTextViewImpl extends TextView{
    ...
    public BibleTextViewImpl(Context context, AttributeSet attrs) {
        super(context, attrs);
        ctx = context;
        setLongClick();
        
        String font = PreferenceManager.getDefaultSharedPreferences(context).getString(context.getString(R.string.text_font_key), "Fanwood");
        
        try {
            //Set Custom font
            this.setTypeface(Typeface.createFromAsset(ctx.getAssets(), "fonts/" + "Ubuntu-R.ttf"),Typeface.NORMAL);
//            this.setTypeface(Typeface.createFromAsset(ctx.getAssets(), "fonts/" + "Ubuntu-B.ttf"), Typeface.BOLD);
    ...
    public BibleTextViewImpl(Context context, BibleText reference) {
        super(context);
...
//        this.setTypeface(tf);
    ...
    public void selectVerse(int characterNumber, int currentStart, int currentEnd) {
    	...
    	Log.e("SelectVerse", "From charpos to verse utility" + bibleText.getVerseFromCharPos(this.getSelectionStart()));
...
//         	setBoldVerse(newSelection, newSelection);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        Log.e("Current selection", " Start:" + start + "End = " + end);
    ...
    public void scrollToVerse(int verse, int extra) {
    	...
    	Log.e("ScrollToVerse", "Scroll to verse: " + verse);
