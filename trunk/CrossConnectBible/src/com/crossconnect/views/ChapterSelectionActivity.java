...
import com.crossconnect.util.BibleDataHelper;
...
//        Set the touch listener for home layout
        ...
        goBtn.setOnClickListener(new OnClickListener(){
            ...
            public void onClick(View arg0) {
                ...
                BibleText bibleText;
                try {
                    bibleText = new SwordBibleText(chapterSelectionTextView.getText().toString(), translationTextView.getText().toString());
        ...
        translationTextView = (TextView) findViewById(R.id.header_translation);
        ...
        translationTextView.setOnClickListener(new OnClickListener(){
...
//                intent.putExtra("WindowId", windowId);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
    	if (resultCode == Activity.RESULT_OK && requestCode == TRANSLATION_SELECT_CODE) {
    		translationTextView.setText((String) data.getExtras().get("Translation"));
        }
