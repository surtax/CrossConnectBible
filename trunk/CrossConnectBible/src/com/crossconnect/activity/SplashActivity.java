...
//            editor.putString("current_book", readFromNFCBibleText.getBook());
//            editor.putString("current_chapter", String.valueOf(readFromNFCBibleText.getChapter()));
//            editor.putString("current_verse", String.valueOf(readFromNFCBibleText.getVerse()));
//            editor.putString("current_translation", readFromNFCBibleText.getTranslation().getInitials());
//
//            
//            // Commit the edits!
//            editor.commit();
