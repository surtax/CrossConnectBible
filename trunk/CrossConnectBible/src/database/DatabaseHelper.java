...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	private static final String WINDOWS_TABLE_CREATE = "CREATE TABLE "
			+ WINDOWS_TABLE_NAME + " ("+ ID + " INTEGER, " + REF_TXT_COL + " TEXT, " + BOOK_COL
	...
	private static final String NOTES_TABLE_CREATE = "CREATE TABLE "
			+ NOTES_TABLE_NAME + " ("+ NOTES_ID_COL + " INTEGER, " + NOTES_BOOK_COL + " TEXT, "  + NOTES_CHAPTER_COL + " INTEGER, " + NOTES_TEXT_COL
			+ " TEXT);";
