...
//    private ArrayList<HashMap<String, String>> bookList = new ArrayList<HashMap<String, String>>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tabs_select_view);
...
//        List<Window> initialWindows = new ArrayList<Window>();
        ...
        for (Window window :initialWindows) {
            ...
            mTabHost.addTab(mTabHost.newTabSpec(window.getBibleText().getReferenceBookChapter())
                    .setIndicator(createTabContent(window.getBibleText().getShortReferenceBookChapterVerse())).setContent(this));
        }
...
//    	Bundle returnedData = data.getExtras();
        ...
        windowsGallery.postDelayed(new Runnable(){
			...
			@Override
			public void run() {
				Intent i = new Intent(TabsActivity.this, ChapterSelectionActivity.class);
