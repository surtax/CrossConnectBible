...
import org.crossconnect.bible.model.WindowImpl;
...
//		db.execSQL("DELETE FROM " + DatabaseHelper.WINDOWS_TABLE_NAME + " where Id = " + window.getId());
	...
	/**
	 * Get a list of windows from the org.crossconnect.bible.database
	 * @return
	 */
...
//			String title = cursor.getString(5);
	...
	/**
	 * Restore an existing window usually from org.crossconnect.bible.database
	 * @param bibleText
	 * @param id
	 * @return
	 */
	...
	/**
	 * Create a new window but does not yet save to the org.crossconnect.bible.database 
