 ...
 * {@link MusicActivity}, which signal the service to perform specific operations: Play, Pause,
 * Rewind, Skip, etc.
 */
public class MusicService extends Service implements OnCompletionListener, OnPreparedListener,
	...
	public static final String ACTION_INITIALISE = "com.example.android.musicplayer.action.INITIALISE";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        else if (action.equals(ACTION_INITIALISE)) processInitialiseRequest();

        return START_NOT_STICKY; // Means we started the service, but don't want it to
                                 // restart in case it's killed.
    }
    
    void processInitialiseRequest() {
    ...
    public int getCurrentPosition() {
    	if(!mState.equals(State.Preparing) && !mState.equals(State.Retrieving)  && mPlayer != null) {
